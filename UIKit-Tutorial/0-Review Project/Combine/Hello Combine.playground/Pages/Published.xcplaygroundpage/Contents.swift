...
// SomeViewModel 클래스 (여기선 이름 name이 @published 키워드로 선언되어 있으므로, 퍼블리셔로서 외부에서도 접근할 수 있음)
...
// SomeViewModel 내부에 선언된 퍼블리셔(생산자)를 $ 키워드를 활용해 가져오고
